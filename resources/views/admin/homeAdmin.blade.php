                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="flex items-center px-6 py-4 space-x-6">
                        ...
                        <form action="{{ route('homeAdmin.show', ['id' => $produit->id]) }}" method="post">
                            {{$produit->id}}
                            @csrf
                            <button wire:click="changeDelete( {{ $produit->id }} )" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">
