...
@section('content')
    <div class="bg-white dark:bg-gray-800">
        ...
        <h3 class="text-gray-600 dark:text-gray-300">10 articles</h3>
        <div class="grid max-w-2xl grid-cols-1 px-4 py-8 mx-auto lg:max-w-7xl gap-y-10 gap-x-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="p-8 rounded-t-lg" src="https://images.unsplash.com/photo-1617196035154-1e7e6e28b0db?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
