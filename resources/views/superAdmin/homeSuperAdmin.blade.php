...
<div class="relative overflow-x-auto shadow-md ">
    <div class="p-5 text-3xl flex justify-between items-center font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        <div>
            ...
            <form action="{{ route('homeSuperAdmin') }}" method="get" accept-charset="UTF-8" role="search">
    ...
    {{ $utilisateurs->links() }}
    @else
        <p class="flex justify-center items-center h-[100px] italic text-3xl text-gray-900 bg-white dark:text-white dark:bg-gray-800 pb-10">Pas d'utilisateurs</p>
    @endif
</div>
